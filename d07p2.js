...
'use strict';
    ...
    */
    ...
    {
        // answer from original instructions
        var a1 = getValue(instructions["a"]);
        ...
        for(var i = 0; i < keys.length; i++)
        {
            ...
            // dont reset instructions with no inputs
            if(!(instruction.i1 === '' && instruction.i2 === '')){
                instruction.outputValue = null;
            }
        }

        // set starting outputValue of "b"
        instructions["b"].outputValue = a1;
